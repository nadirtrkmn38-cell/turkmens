...
PANELS = [
    ...
    ("p_biz", 1730, sy(8) + 100, 250, 300, "★ BİZİM DEVREYE GİRDİĞİMİZ YER", [
        ...
        "• Atık ısı geri kazanımı ve ısı pompası uygulamaları",
        ...
        "• Kestirimci bakım ve veri altyapısı — izleme, raporlama ve doğrulama yükümlülüğüyle aynı altyapıyı besler",
        "• Fizibilite: geri ödeme ve net bugünkü değer (NBD) hesabına tahsisat maliyetinin dâhil edilmesi",
        "• Verimlilik Artırıcı Proje (VAP) destekleri ve 9903 sayılı Yatırımlarda Devlet Yardımları Hakkında Cumhurbaşkanı Kararı kapsamındaki teşviklerle yatırım maliyetinin düşürülmesi",
